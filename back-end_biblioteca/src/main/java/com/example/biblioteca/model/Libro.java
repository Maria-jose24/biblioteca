...
public class Libro {
	...
	public boolean contieneCamposVacios() {
		return this.titulo.isEmpty() || this.autor.isEmpty() || this.isbn.isEmpty() ||
				this.genero.isEmpty() || this.numero_de_ejemplares_disponibles.isEmpty() ||
				this.numero_de_ejemplares_ocupados.isEmpty();
	}

	public boolean isbnValido() {
		return this.isbn.matches("\\d{13}");
	}
}